        ...
        <div className="flex flex-col h-full">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 p-4">
            ...
            <div className="space-y-2">
              <Link
                to="/profile"
                className="flex items-center space-x-2 px-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200"
              >
              ...
              <button
                ...
                className="flex items-center space-x-2 px-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200 w-full text-left"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-between h-16 px-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden sm:flex items-center space-x-2 text-sm">
                ...
                <span className="text-gray-600 dark:text-gray-300">Market Open</span>
              </div>
